...
import { Box, Button, Link, MenuItem, Select, Stack, TextField, Typography } from '@mui/material';
...
const Page = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      try {
        await auth.signUp(values.email, values.name, values.password, values.level);
        router.push('/');
      } catch (err) {
